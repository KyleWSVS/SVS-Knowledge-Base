            ...
            <div class="score-grid">
                <div class="score-item">
                    <div class="score-number <?php
                        ...
                        elseif ($attempt['score'] >= 70) echo 'good';
                        elseif ($attempt['score'] >= 50) echo 'fair';
                        else echo 'poor';
                    ?>">
                ...
                <div class="user-answer">
                    ...
                    <div class="result-feedback <?php echo $question['user_choice']['is_correct'] ? 'correct' : 'incorrect'; ?>">
                        ...
                        <span class="feedback-text">
                            <?php echo $question['user_choice']['is_correct']
                                ? 'Correct'
                                : 'Incorrect'; ?>
                        </span>
                    </div>
        ...
        <?php if ($attempt['status'] === 'failed'): ?>
            <div class="study-tips">
                ...
                <ul>
                    ...
                    <li>Consider making notes of important information while studying</li>
                </ul>
            </div>
        <?php endif; ?>
